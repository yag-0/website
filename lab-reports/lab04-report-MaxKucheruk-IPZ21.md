...
- Кучерук Максим Сергійовчи: опис виконаних завдань (повне виконання описанної вище роботи)
...
![Форма зворотного зв'язку](lab-reports/screen4lab/zvorzvyaz.png)

### Каталог товарів

![Каталог товарів](lab-reports/screen4lab/tovari.png)

### Адміністративна панель

![Адмін-панель](lab-reports/screen4lab/admin.png)

### Управління замовленнями

![Управління замовленнями](lab-reports/screen4lab/uprzam.png)

### Додаткова функціональність

![Управління промокодами](lab-reports/screen4lab/addpromo.png)
